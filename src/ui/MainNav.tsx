...
import { HiOutlineAdjustmentsVertical, HiOutlineCalendarDays, HiOutlineHome, HiOutlineHomeModern, HiOutlineUsers } from "react-icons/hi2";
  ...
  return (
    <nav>
      <NavList>
        ...
        <li><StyledNavLink to='/settings'><HiOutlineAdjustmentsVertical/><span>Settings</span></StyledNavLink></li>
      </NavList>
    </nav>
  );
}
